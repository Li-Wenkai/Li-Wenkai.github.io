...
short_title: "IMBH-TDE Model" # ← 新增：用于Research卡片显示
summary: Inefficient circularization, delayed stream-disk interaction and reprocessing for the intermediate-mass black hole tidal disruption event EP240222a.
description:
